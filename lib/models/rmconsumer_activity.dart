class RmConsumerActivity {
  ...
  factory RmConsumerActivity.fromJson(Map<String, dynamic> json) {
    return RmConsumerActivity(
      ...
      mtdSubmission: double.tryParse(json["MTD_SUBMISSION"].toString()) ?? 0.0,
      mtdNtb: double.tryParse(json["MTD_NTB"].toString()) ?? 0.0,
